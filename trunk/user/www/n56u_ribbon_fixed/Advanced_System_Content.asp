                                ...
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
										...
										<tr>
                                            ...
                                            <td>
                                                <input type="text" maxlength="128" class="input" size="32" name="ntp_server1" value="<% nvram_get_x("","ntp_server2"); %>" onKeyPress="return is_string(this,event);"/>
                                            </td>
                                        </tr>
										<tr>
                                            ...
                                            <td>
                                                <input type="text" maxlength="128" class="input" size="32" name="ntp_server1" value="<% nvram_get_x("","ntp_server3"); %>" onKeyPress="return is_string(this,event);"/>
                                            </td>
                                        </tr>
